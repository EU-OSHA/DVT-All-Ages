define(function (require) {
    ...
    var angular = require('common-ui/angular'),
        ...
        issueModule = require('vertical/issue/issue-module'),
        approachesModule = require('vertical/approaches/policies-module'),
        countriesModule = require('vertical/countries/countries-module'),
        methodologyModule = require('vertical/methodology/methodology-module'),
     ...
     * @requires homeModule
     * @requires issueModule
     * @requires approachesModule
     * @requires countriesModule
     * @requires methodologyModule
     * @requires glossaryModule
    ...
    var app = angular.module('dvt', ['ui.bootstrap',
                                     ...
                                     homeModule.name,
                                     issueModule.name,
                                     approachesModule.name,
                                     countriesModule.name,
                                     methodologyModule.name,
                                     glossaryModule.name,
                                     configModule.name,
