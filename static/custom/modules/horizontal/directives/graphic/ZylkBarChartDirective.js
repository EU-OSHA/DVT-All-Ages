 ...
 * @param {String} [cda="all-ages/dashboards/allagesdash.cda"]   CDA file path.
...
define(function (require) {
    ...
    var legendDescription = require('json!dvt/graphic/legendDescription');
    ...
    function ZylkBarChartDirective(dataService, plotsProvider, exportService, $log, maximize, $cookies) {
      ...
      //  }
        ...
        _template +='</div>'
            ...
            + '</div>'
            + '<div class="legend-info" ng-if="isMaximized && legendClickMode" data-ng-bind="legendDesc.legendDescriptionTitle"></div>'
            ...
            link: function (scope, element, attributes, controllers) {
                ...
                var definition = {
                    ...
                    chartDefinition: {
                        ...
                        path: attributes.cda || "all-ages/dashboards/datapilot.cda",
