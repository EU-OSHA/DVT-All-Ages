/**
 * @ngdoc directive
 * @name dvt.charting.directive:ZylkPyramidChart
 * @scope
 * @restrict E
 *
 * @description
...
define(function (require) {
    ...
    function ZylkBarChartDirective(dataService, $log, plotsProvider, exportService, dvtUtils, maximize) {
       ...
       // }
        ...
        _template+= '</div>'
            ...
            + '</div>'
            + '</div>'
            + '<div data-ng-if="isMaximized" class="zylk-bar-chart">'
            + '<div class="row">'
        ...
        _template+='</div>'
            ...
            + '</div>'
            + '</div>'
            + '<div class="logoGraphics-wrapper"><img alt="European Agency for Safety and Health at Work" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/all-ages/static/custom/img/EU-OSHA-trans-en.png" class="logoGraphics"></div>'
            + '<div class="functionalLegend" data-ng-bind-html="functionalLegend"></div>'
            + '</div>'
        ...
        return {
            ...
            // TODO extract template same ZylkBarchartDirective
            template: _template,
    ...
    ZylkBarChartDirective.$inject = ['dataService', '$log', 'plotsProvider', 'exportService', 'dvtUtils', 'maximize'];
