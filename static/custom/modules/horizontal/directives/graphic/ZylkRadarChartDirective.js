/**
 * @ngdoc directive
 * @name dvt.charting.directive:ZylkRadar
 * @scope
 * @restrict E
 *
 * @description
...
define(function (require) {
    ...
    function ZylkRadarDirective( $q, $log, dvtUtils, plotsProvider, exportService, dataService, maximize) {
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
         template='<div class="col-md-12 dvt-chart radar">'
             ...
             + '<div class="logoGraphics-wrapper"><img alt="European Agency for Safety and Health at Work" src="/pentaho/plugin/pentaho-cdf-dd/api/resources/system/all-ages/static/custom/img/EU-OSHA-en.png" class="logoGraphics"></div>'
        ...
        return {
            ...
            link: function (scope, element, attributes, controllers) {
                ...
                scope.id = "zylk_radarChart" + nextId();
                ...
                var definition = {
                    ...
                    customfunction: function f() {
                        function Radar(paper, cx, cy, r, values, secondIndicatorValues, opts) {
                            ...
                            var circle = function (cx, cy, r, angle, value, max, title, theme) {
                                var colorStroke =
                                ...
                                var outerRadius = title == country1 || title == country2 || title== "EU"
                                                    ? opts.pathCircleOuterRadius * 6
                                                    : opts.pathCircleOuterRadius * 2;
                            ...
                            var shape = function(x,y,indicator){
                                var color = dvtUtils.getSpiderIndicator(indicator);
                            ...
                            var technicalLegend = function(x,y){
                                ...
                                paper.text(x, y, opts.indicators[1])
                                    .attr({
                                        "fill": dvtUtils.getSpiderIndicator(1),
                                        "text-anchor": "start",
                                        "font-size": "15px",
                                        "font-family": "Open Sans",
                                        "font": ""
                                ...
                                var length = opts.indicators[1].length;
                                x += length > 10 ? length*7: length*10;
                                x = shape(x,y,0);
                                paper.text(x, y, opts.indicators[0])
                                    .attr({
                                        "fill": dvtUtils.getSpiderIndicator(0),
                                        "text-anchor": "start",
                                        "font-size": "15px",
                                        "font-family": "Open Sans",
                                        "font": ""
                            ...
                            if (!!opts.drawLabels) {
                                ...
                                while (i--) {
                                    ...
                                    var labelSize =
                                        (fulltext == country1 || fulltext == country2 || fulltext == "EU" ) ? 20 : opts.labelFontSize;
                            ...
                            if(!!opts.showTechnicalLegend){
                                var x = (paper.width * 0.4) - (opts.indicators[0].length*4);
                            ...
                            if(!!secondIndicatorValues){
                                var theme = {
                                    pathStroke: dvtUtils.getSpiderIndicator(1),
                                    pathFill:'none',
                                    pathStrokeWidth: 3,
                                    pathCircleStroke: dvtUtils.getSpiderIndicator(1)
                                };
                                ...
                                if (!!opts.drawPathCircles) {
                                    ...
                                    while (i--) {
                                        circle(cx, cy, r, startAngle + angle * i, secondIndicatorValues[i], opts.max, opts.labels[i], theme);
                                    }
                                }
                        ...
                        //public
                        Raphael.fn.radar = function (cx, cy, r, values, secondIndicatorValues, opts) {
                            return new Radar(this, cx, cy, r, values, secondIndicatorValues, opts);
                        };
                        ...
                        $q.all(scope.promises)
                            .then(function (dataset) {
                                ...
                                //x,y,R
                                paper.radar((definition.width / 2) - 20, (definition.height / 2) - 20, attributes.radio, firstIndicatorValues, secondIndicatorValues,
                                    {
                                        meshSize: attributes.meshSize || 30,//the space between adjacent meshes,
                                        labels: firstIndicatorLabels,
                                        labelFontSize: 13, //huge font
                                        ...
                                        pathStroke: dvtUtils.getSpiderIndicator(0), //color of data path stroke (area) 'rgba(120, 120, 120, .5)'
                                        ...
                                        pathCircleStroke: dvtUtils.getSpiderIndicator(0), //
    ...
    ZylkRadarDirective.$inject = ['$q','$log', 'dvtUtils', 'plotsProvider','exportService','dataService','maximize'];

    return ZylkRadarDirective;
})
